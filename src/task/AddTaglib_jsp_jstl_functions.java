...
public class AddTaglib_jsp_jstl_functions {

	private static int count = 0;
	private static int fileCount = 0;
	private static final String LINE = "<%@ taglib uri=\"http://java.sun.com/jsp/jstl/functions\" prefix=\"fn\" %>";
	
	public static void main(String[] args) {
		
		String [] directoryList = {"C:\\Workspace_Feng_Yang\\NewWorkSpace2\\JavaTraining\\TestFile\\AddTaglib_csrf"};
